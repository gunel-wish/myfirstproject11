...
public class LogicalOperator_SinglePipe {
    ...
    public static void main(String[] args) {
        ...
        // do you have  milk store 1 : if yes get it and stop checking the rest of the store
        // that's exactly what double (2) pipe || do , it stop as long as it sees one
        // | single pipe will check each and every store even you already got you milk

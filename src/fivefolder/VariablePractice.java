...
public class VariablePractice {
    ...
    public static void main(String[] args) {
        ...
        /*
         ...
         logical numbers    : boolean ( true , false )
        ...
        // generate this output of : You are driving 10 mhp than speed limit
        // speed limit as int , currentSpeed as int , overTheLimit as int
        int speedLimit = 65 ;
        int currentSpeed =95 ;

        int overTheLimit  = currentSpeed - speedLimit ;
        System.out.println( "You are driving " + overTheLimit +  " mhp  more than speed limit");

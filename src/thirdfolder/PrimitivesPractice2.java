...
public class PrimitivesPractice2 {
    ...
    public static void main(String[] args) {
        ...
        // use above example tp print out the rest of the variable value in similar format.
        ...
        double priceIpadPro = 1024.99D ;
        // compiler automatically assume it's a double so it's not required to have d
        // However for good programing habit , add them always
        double priceOfMac   = 2299.99  ;

        // If you have a wole number by itself , compiler automatically assume it is an int
